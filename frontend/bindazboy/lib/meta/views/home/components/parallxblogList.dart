...
class _BloglistState extends State<Bloglist> {
  ...
  final GlobalKey _backgroudimagekey = GlobalKey();
                ...
                children: [
                  Flow(
                    delegate: ParallexFlowDelegate(
                        ...
                        backgroundkey: _backgroudimagekey),
                    children: [
                      Image.network(
                        _blog.blogImage,
                        key: _backgroudimagekey,
                        fit: BoxFit.cover,
                      ),
                    ],
                  ),
...
class ParallexFlowDelegate extends FlowDelegate {
  ...
  @override
  BoxConstraints getConstraintsForChild(int i, BoxConstraints boxConstraints) {
    return BoxConstraints.tightFor(width: boxConstraints.maxWidth);
  }
  ...
  void paintChildren(FlowPaintingContext context) {
    ...
    final verticalAliment = Alignment(0.0, scrollFraction * 2 - 1);
    final backgroundSize =
        (backgroundkey.currentContext!.findRenderObject() as RenderBox).size;

    final listItemSize = context.size;

    final childRect =
        verticalAliment.inscribe(backgroundSize, Offset.zero & listItemSize);
