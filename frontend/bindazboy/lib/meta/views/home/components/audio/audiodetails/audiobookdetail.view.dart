      ...
      child: Stack(
        children: [
          ...
          SlidingUpPanel(
            ...
            panelBuilder: (controller) => AudiobookLowerpanel(
  ...
  Widget slider() {
    ...
    return SizedBox(
      ...
      child: Slider(
          ...
          max: audioutilty.audioduration?.inSeconds.toDouble() ??
              Duration.zero.inSeconds.toDouble(),
          value: audioutilty.audiopostion?.inSeconds.toDouble() ??
              Duration.zero.inSeconds.toDouble(),
