...
class ContactusView extends StatefulWidget {
  ...
  const ContactusView({super.key, required this.reportandcontactArguments});
...
class _ContactusViewState extends State<ContactusView> {
  ...
  Widget build(BuildContext context) {
    ...
    final contactusprovider = Provider.of<ContactusNotifier>(
      context,
      listen: false,
    );
    return WillPopScope(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  title(controller: _titletext, text: "Enter here"),
    ...
    return ElevatedButton(
      ...
      child: Text(
        ...
        style: const TextStyle(
          color: Color.fromARGB(255, 239, 245, 110),
          fontSize: 17,
        ),
      ),
    );
