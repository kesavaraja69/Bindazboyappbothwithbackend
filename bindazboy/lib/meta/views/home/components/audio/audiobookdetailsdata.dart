...
class AudiobookDetailsdata extends StatefulWidget {
  ...
  const AudiobookDetailsdata({
    super.key,
    required this.audiobookDetailArguments,
  });
      ...
      body: SizedBox(
        ...
        child: FutureBuilder(
          future: audioprovider.fetchAudioBookdetail(
            context: context,
            audioid: widget.audiobookDetailArguments.id,
          ),
          builder: (context, snapshot) {
            ...
            if (snapshot.data != null) {
              var snapshot1 = snapshot.data;
              return AudioDetailsView(snapdata: snapshot1);
            } else {
              return Center(
                child: Text(
