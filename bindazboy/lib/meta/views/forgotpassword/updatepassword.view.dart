...
class UpdatePasswordView extends StatefulWidget {
  ...
  const UpdatePasswordView({super.key, required this.updatePasswordArguments});
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (updatepassword1.isNotEmpty &&
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text("Password is not matched")),
                      );
                    }
                  },
                  ...
                  child: Text("Update", style: TextStyle(color: Colors.yellow)),
                ),
              ],
            ),
          ),
