...
class ForgotPasswordNotifer extends ChangeNotifier {
  ...
  Future forgotPassword({
    ...
    try {
      var userData = await forgotPasswordAPI.forgotPassword(
        context: context,
        useremail: useremail,
      );
  ...
  Future otpVerification({
    ...
    try {
      var userData = await forgotPasswordAPI.otpVerification(
        context: context,
        otpcode: otpcode,
        useremail: useremail,
      );
  ...
  Future updatePassword({
    ...
    try {
      var userData = await forgotPasswordAPI.updatePassword(
        context: context,
