              ...
              onclick: () async {
                await zoomProvider
                    .updateregisterZoom(
                      ...
                      zoomAvaibleSlot: int.parse(_zoomAvailaibleslottext.text),
