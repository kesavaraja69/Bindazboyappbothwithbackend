...
import 'package:adminbindazboyapp/meta/views/updateblog/images/imagesList.dart';
...
class UpdateBlog extends StatefulWidget {
  ...
  const UpdateBlog({super.key, required this.blogDetailArguments});
...
class _UpdateBlogState extends State<UpdateBlog> {
  ...
  void initState() {
    ...
    _titletext = TextEditingController(
      text: widget.blogDetailArguments.blogTitle,
    );
    _descriptiontext = TextEditingController(
      text: widget.blogDetailArguments.blogDescription,
    );
  }
                      ...
                      child: subitbutton(
                        ...
                        onclick: () async {
                          ...
                          if (_mainimageurltext.text.isEmpty &&
                              widget.blogDetailArguments.blogImage!.isEmpty) {
                          ...
                          Future.delayed(
                            ...
                            await blogNotifer
                                .updateBlogs(
                                  ...
                                  blog_image:
                                      _mainimageurltext.text.isEmpty
                                  ...
                                  blog_audio:
                                      ...
                                      (datadetails.blogAudio),
                                  blog_images:
                                      utilityNotifer.myListdatafnimages!.isEmpty
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Center(
              child: GestureDetector(
                onTap: onclick,
                child: Icon(CupertinoIcons.photo, color: Colors.yellow),
              ),
            ),
          ),
        ),
          ...
          child: Container(
            ...
            child: Center(
              child: GestureDetector(
                ...
                child: Icon(CupertinoIcons.cloud_upload, color: Colors.yellow),
              ),
            ),
          ),
        ),
