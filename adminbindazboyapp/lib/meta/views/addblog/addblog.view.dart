                    ...
                    Future.delayed(Duration(seconds: 3)).whenComplete(() async {
                      if (_titletext.text.isNotEmpty &&
                        ...
                        await blogNotifer.addBlogs(
                          ...
                          blog_audio: utilityNotifer.audioURL,
                          blog_images: utilityNotifer.myListfnimages,
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text("fill the value")),
                        );
                      }
                    });
                  },
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Center(
              child: GestureDetector(
                onTap: onclick1,
                child: Icon(CupertinoIcons.delete, color: Colors.yellow),
              ),
            ),
          ),
        ),
  ...
  Widget iconcontainer({required onclick}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(CupertinoIcons.photo, color: Colors.black, size: 50.0),
      ),
    );
  }
