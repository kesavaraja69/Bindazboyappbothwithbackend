...
class _HomeblogViewState extends State<HomeblogView> {
  ...
  Widget build(BuildContext context) {
    ...
    final userprovider = Provider.of<AuthenticationNotifier>(
      context,
      listen: true,
    );
    return Scaffold(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        final zoomProvider = Provider.of<ZoomNoitifer>(
                          context,
                          listen: false,
                        );
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return ZoomUpdateDetailsView(
                                ...
                                zoomupcomingDatetime:
                                    fndata.zoommeetupcomingdate,
                              );
                            },
                          ),
                        );
